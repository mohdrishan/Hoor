      ...
      <div className="container-xl relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
          ...
          <SlideIn direction="left">
            ...
            <p className="body-copy text-sm leading-loose">
              The abaya continues to evolve through generations — honouring tradition while embracing contemporary style. With flowing cuts, premium fabrics, and elegant details, each piece delivers beauty, versatility, and confidence.
            </p>
          </SlideIn>

          <SlideIn direction="right" delay={0.12}>
            {/* Truthful stats — 4 abayas, 1 signature collection */}
            <div className="grid grid-cols-2 gap-px bg-onyx/8">
              {[
                { n: '4',    l: 'Curated Abayas'    },
                { n: '1',    l: 'Signature Collection' },
            ...
            <div className="mt-6 border border-gold/15 p-8 relative">
              ...
              <p className="font-display text-xl font-light italic text-onyx/70 leading-relaxed">
                &ldquo;Modesty is not a limitation. It is the language of the deeply confident.&rdquo;
              </p>
            </div>
          </SlideIn>
        </div>
